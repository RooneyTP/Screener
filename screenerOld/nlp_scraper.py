...
_SENTIMENT_CACHE_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "_sentiment_cache")
...
def _cache_key(ticker: str) -> str:
    return os.path.join(_SENTIMENT_CACHE_DIR, hashlib.md5(ticker.encode()).hexdigest() + ".json")
